...
├─────────────────────────────────────────────────────────────────────┤
│  AGGREGATE SCORE + HEADLINE RECOMMENDATION                         │
│  ╔═════════════════════════════════════════════════════════════╗   │
│  ║  Direction: SHORT/LONG/WAIT · Confidence: XX%              ║   │
│  ║  Entry: $X,XXX–$X,XXX · Stop: $X,XXX · Target: $X,XXX    ║   │
│  ║  Hold: [ENTRY TIME] → [EXIT TIME CST]                      ║   │
│  ║  BTC trigger: [level] · Kill switch: [invalidation]        ║   │
│  ╚═════════════════════════════════════════════════════════════╝   │
├─────────────────────────────────────────────────────────────────────┤
│  OPTION A — 5× [SHORT/LONG]              [RED or GREEN BOX]       │
│  Best entry: [price zone + condition]    Confidence: XX%          │
│  [Thesis: 2 sentences citing specific metric values]              │
│  Entry: $X,XXX   Target 1: $X,XXX   Target 2: $X,XXX            │
│  Stop: $X,XXX    Manual exit: $X,XXX (5–10% if stalls)          │
│  ████████████████░░░░  XX% probability                            │
│  [Risk pill 1]  [Risk pill 2]  [Risk pill 3]                      │
├─────────────────────────────────────────────────────────────────────┤
│  OPTION B — 5× [LONG/SHORT — contrarian] [OPPOSITE COLOR BOX]    │
│  Only valid if: [specific BTC level + ETH condition]              │
│  [Contrarian thesis: why longs flushed / shorts crowded etc.]    │
│  Entry: $X,XXX   Target: $X,XXX   Stop: $X,XXX (tight)          │
│  ████░░░░░░░░░░░░░░░░  XX% — high-risk, high-velocity            │
│  [Risk pill 1]  [Risk pill 2]  [Bull pill 1]  [Bull pill 2]      │
├─────────────────────────────────────────────────────────────────────┤
│  OPTION C — WAIT for better location     [AMBER BOX]              │
│  [Why neither A nor B has clean R/R right now — 2 sentences]     │
│  Watch: → [A trigger]  → [B trigger]  → [invalidation level]     │
├─────────────────────────────────────────────────────────────────────┤
│  RANKED SUMMARY                                                    │
│  1st: [OPTION A badge] — [entry] · Stop [stop] · Tgt [target]    │
│  2nd: [OPTION C badge] — Wait for [specific trigger]              │
│  3rd: [OPTION B badge] — Only if [specific condition]             │
│  Override rule: Close at 5–8% gain if momentum stalls before tgt  │
└─────────────────────────────────────────────────────────────────────┘
```
...
## 🅰️🅱️🅲 Required Options Panel (A / B / C)

**This section is mandatory.** After the signal scorecard and aggregate recommendation, the dashboard must always render three distinct trade options — the primary recommendation, the contrarian alternative, and the wait/patience option. This ranked options format was validated across all live trading sessions June 24–27, 2026 and is the most actionable output the dashboard produces.

**Never collapse this to a single recommendation.** The Options panel forces explicit acknowledgment of the contrarian case and the do-nothing discipline, both of which are critical to the trading system.

### Option A — Primary Direction (SHORT or LONG)

```
┌─ OPTION A — 5× [SHORT / LONG] ────────────────────────────────────┐
│ Best entry: [specific price zone and condition]                    │
│                                                                    │
│ [2–3 sentence thesis explaining WHY this is the primary play,     │
│  grounded in the metric data — not generic. Reference specific    │
│  data points: RSI level, EMA position, funding rate, F&G score]  │
│                                                                    │
│  Ideal entry:      $X,XXX – $X,XXX                               │
│  If entering now:  $X,XXX (sub-optimal / optimal)                │
│  Primary target:   $X,XXX                                        │
│  Secondary target: $X,XXX                                        │
│  Stop loss:        $X,XXX                                        │
│  Manual exit:      $X,XXX (5–10% gain if momentum stalls)       │
│                                                                    │
│  Confidence bar:   ████████████████░░░░  XX% probability         │
│                                                                    │
...
**Option A rules:**
- Always the direction the aggregate score supports
- Entry must be specific — a zone with a condition, not just a number
- Thesis must cite actual metric values, not just direction labels
- Confidence bar width = the probability score (e.g., 65% = 65% fill)
- Risks must be real and specific — "BTC breaks $58K" not "market could go down"
- If Option A is SHORT, the entry ideal zone is at resistance, not at current price sitting on support

### Option B — Contrarian / Opposite Direction

```
┌─ OPTION B — 5× [LONG / SHORT — opposite of A] ───────────────────┐
│ Contrarian play — only valid if: [specific conditions]            │
│                                                                    │
│ [2–3 sentence contrarian thesis. Acknowledge the dominant trend   │
│  and explain specifically what data supports the opposite case:   │
│  RSI oversold, liquidation flush, smart money signals, F&G       │
│  capitulation, short squeeze setup, etc.]                         │
│                                                                    │
│  Entry condition:  [Specific trigger — e.g., "ETH holds $1,555   │
│                    AND BTC reclaims $60K with volume"]           │
│  Entry zone:       $X,XXX – $X,XXX                               │
│  Primary target:   $X,XXX                                        │
│  Secondary target: $X,XXX                                        │
│  Stop loss:        $X,XXX (tighter than Option A)                │
│  Manual exit:      Exit fast at first target — this is a scalp   │
│                                                                    │
│  Confidence bar:   ████░░░░░░░░░░░░░░░░  XX% probability         │
│                                                                    │
│  RISKS:  [Risk pill 1] [Risk pill 2]                             │
│  BULL CASE:  [Bull pill 1] [Bull pill 2]                        │
└────────────────────────────────────────────────────────────────────┘
```

**Option B rules:**
- Always the opposite direction of Option A — never the same direction at a different entry
- Probability is always lower than Option A (contrarian = minority probability by definition)
- Entry requires a specific confirming condition — not just price, but a trigger (e.g., BTC level, RSI cross)
- Stop must be tighter than Option A — contrarian trades have less room to be wrong
- Must include at least one "bull pill" — the specific catalyst that would make this work fast
- Label explicitly: "This is a low-probability but high-velocity trade — if it works it works fast"

### Option C — Wait / No Trade

```
┌─ OPTION C — WAIT for better location ─────────────────────────────┐
│ Neither entry right now is ideal                                   │
│                                                                    │
│ [2–3 sentences explaining why waiting is the correct discipline   │
│  right now. Cite the specific condition that makes both A and B   │
│  sub-optimal at this moment — e.g., price sitting on support      │
│  (bad for short), macro uncertainty (bad for long), thin          │
│  liquidity window, unfavorable exit timing, etc.]                │
│                                                                    │
│ WATCH FOR:                                                         │
│  → [Trigger 1 that activates Option A]                           │
│  → [Trigger 2 that activates Option B]                           │
│  → [Price level that invalidates both — means reassess entirely]  │
└────────────────────────────────────────────────────────────────────┘
```

**Option C rules:**
- Always present — never omit even when there is a clear directional bias
- Option C is not weak — it represents the discipline principle "patience is a position"
- Must specify exactly what the trader should watch for to transition from WAIT to A or B
- Reference the time window: if Asia session or thin liquidity, weight Option C more heavily
- If the trader has already made a profitable trade today, note this as a factor in favor of C

### Ranked Summary Table (bottom of Options Panel)

```
┌─ RANKED RECOMMENDATION ────────────────────────────────────────────┐
│ 1st choice: [OPTION A BADGE] — [Entry] · Stop [STOP] · Tgt [TGT] │
│ 2nd choice: [OPTION C BADGE] — Wait for [specific trigger]        │
│ 3rd choice: [OPTION B BADGE] — Only if [specific condition]       │
│                                                                    │
│ Exit window:    [START TIME CST] – [END TIME CST]                 │
│ Override rule:  Close manually at 5–8% gain if momentum stalls    │
└────────────────────────────────────────────────────────────────────┘
```

### HTML/CSS implementation reference

The Options panel uses three distinct visual treatments from the sample HTML:

```css
/* Option A — primary direction */
.short-box { background: #FCEBEB; border: 1px solid #F09595; }  /* if SHORT */
.long-box  { background: #EAF3DE; border: 1px solid #97C459; }  /* if LONG */

/* Option B — contrarian */
.long-box  { background: #EAF3DE; border: 1px solid #97C459; }  /* if contrarian LONG */
.short-box { background: #FCEBEB; border: 1px solid #F09595; }  /* if contrarian SHORT */

/* Option C — wait */
.wait-box  { background: #FAEEDA; border: 1px solid #FAC775; }

/* Risk pills (negative) */
.risk-pill { background: #FCEBEB; color: #A32D2D; }

/* Bull pills (positive catalyst in contrarian case) */
.bull-pill { background: #EAF3DE; color: #3B6D11; }

/* Confidence bar */
.conf-bar-fill-short { background: #E24B4A; }
.conf-bar-fill-long  { background: #639922; }
```

### When to adjust the A/B/C weighting

| Market condition | Adjustment |
|---|---|
| Price sitting on key support | Option A (short) drops in confidence; Option C rises |
| Price at proven resistance | Option A (long) drops in confidence; Option C rises |
| RSI < 30 + F&G < 20 | Option B (contrarian long) confidence rises; note capitulation |
| RSI > 70 + F&G > 80 | Option B (contrarian short) confidence rises; note euphoria |
| Asia session (23:00–08:00 CST) | Option C weight increases; flag thin liquidity |
| 4+ consecutive down days | Note selling exhaustion; Option B long weight rises |
| 4+ consecutive up days | Note buying exhaustion; Option B short weight rises |
| Trader already profitable today | Increase Option C weight; note discipline |
| Major macro event in hold window | Reduce both A and B confidence; increase C |
...
> 5. Renders the full dashboard layout: live metrics → scorecard tiles → bear/bull bar → recommendation box → **Options A/B/C panel** → ranked summary
> 6. Includes a REFRESH button to re-fetch all data and recalculate
>
> **The Options A/B/C panel is mandatory and must always render three distinct trade options:**
>
> - **Option A** (primary direction — SHORT or LONG): The play the aggregate score supports. Styled in RED box (if short) or GREEN box (if long). Includes: entry zone with condition, primary target, secondary target, stop loss, manual exit level, a confidence bar (width = probability %), and specific risk pills showing what would kill the thesis. Thesis narrative must cite actual metric values, not generic labels.
>
> - **Option B** (contrarian — opposite direction): The minority-probability case. Opposite color box from A. Requires a specific trigger condition to be valid (e.g., "ETH holds $1,555 AND BTC reclaims $60K"). Tighter stop than A. Must include "bull pills" showing what catalyst makes it work. Label it: "Low-probability but high-velocity — if it works it works fast."
>
> - **Option C** (WAIT / no trade): Always present. AMBER box. Explains in 2 sentences why neither A nor B has clean R/R right now. Lists specific triggers to watch that activate A or B. This represents the discipline principle: "patience is a position."
>
> - **Ranked Summary**: A table beneath the three options showing 1st/2nd/3rd choice with badge, entry, stop, target, and the override rule (close at 5–8% gain if momentum stalls).
>
> **Options panel weighting rules for the AI to apply:**
> - Price on key support → lower A (short) confidence, raise C weight
> - Price at resistance → lower A (long) confidence, raise C weight
> - RSI < 30 + F&G < 20 → raise B (contrarian long) confidence, note capitulation
> - RSI > 70 + F&G > 80 → raise B (contrarian short) confidence, note euphoria
> - Asia session (23:00–08:00 CST) → raise C weight, flag thin liquidity
> - 4+ consecutive down days → note selling exhaustion, raise B (long) weight
> - Trader already profitable today → raise C weight, note discipline
>
> **Do NOT use:**
...
| 1.2 | June 28, 2026 | Added mandatory Options A/B/C panel — ranked three-option output format validated across live trading sessions June 24–27. Includes: Option A (primary, red/green box, confidence bar, risk pills), Option B (contrarian, tighter stop, bull pills, specific trigger), Option C (wait, amber box, watch triggers), and ranked summary table. HTML/CSS reference added. AI weighting rules for options added. Dashboard wireframe updated. System prompt updated to require A/B/C explicitly. |
